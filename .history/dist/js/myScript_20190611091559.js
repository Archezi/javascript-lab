...
var controller = (function(UICtrl) {
    ...
    var setupEventListeners = function() {
        ...
        // 2.Contacts
        document.querySelector(DOM.contactBtn).addEventListener("click", menuBtn);
        // 3. Footer legal button
        document.querySelector(DOM.footerLegal).addEventListener("click", footerLegalBtn);
        // 4. Footer social button
        document.querySelector(DOM.footerSocial).addEventListener("click", footerSocialBtn);
